...
public class PropertyListFragment extends Fragment {
    ...
    private void loadMockProperties() {
        ...
        mockProperties.add(new Property(
                ...
                1072,
                8,
                "Luxury condo featuring 8 bedrooms, 10 baths, and breathtaking views of Manhattan.",
                address1,
                photos1,
                pointsOfInterest1,
        ...
        mockProperties.add(new Property(
                ...
                374,
                3,
                "Charming family residence with 3 bedrooms, 5 baths, and a large backyard, located in Montauk.",
                address2,
                photos2,
                pointsOfInterest2,
                false, // Toujours disponible
